...
/**
 * Updates the difficulty for a given translation
 *
 * @param {String} id
...
export async function updateDifficulty({id, difficulty}) {
    const translation = await TranslationModel.update({column: "difficulty", value: difficulty, where: {column: "id", value: id}});
    return translation;
}
